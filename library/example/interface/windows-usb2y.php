...
// if(mysqli_num_rows($sql_i)==0){
//     mysqli_query($connect, "insert into tb_pilih(nama_calon, jumlah_vote, id_calon) value ('Tidak Hadir','$jumlah_b','0'");
// }else {
