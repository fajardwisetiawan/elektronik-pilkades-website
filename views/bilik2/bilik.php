...
<head>
    ...
    <title>Bilik - Pemilihan Umum</title>
                        ...
                        <div class="col-xl-6 col-md-6 col-12">
                            <div class="card border-teal border-lighten-2">
                                <div class="text-center">
                                    <div class="card-body">
                                        <?php if($qy['foto'] == ''){ ?>
                                            <input type="image" src="../../logo/avatar0.jpg" class="rounded-circle width-150 height-150" alt="Card image" onclick="window.location.href='../../library/example/interface/windows-usb2y.php?no_urut=<?= $qy['no_urut'] ?>&&nama=<?= $qy['nama'] ?>'"/>
                                         <?php }else{ ?>
                                        <div class="hd-message-img">
                                            <input type="image" src="../../image/<?= $qy['foto']; ?>" class="rounded-circle width-150 height-150" alt="Card image" onclick="window.location.href='../../library/example/interface/windows-usb2y.php?no_urut=<?= $qy['no_urut'] ?>&&pin=<?= $pin; ?>&&id_calon=<?= $qy['id_calon'] ?>&&nama=<?= $qy['nama'] ?>&&qr=<?= $qy['qr'] ?>&&rw=<?= $rw; ?>'"/>
                                        </div>
                                        <?php } ?>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="card border-teal border-lighten-2">
                                <div class="text-center">
                                    <div class="card-body">                   
                                        ...
                                        <input type="image" src="../../logo/avatar0.jpg" class="rounded-circle width-150 height-150" alt="Card image" onclick="window.location.href='../../library/example/interface/golput2.php?pin=<?= $pin; ?>&&rw=<?= $rw; ?>'"/>
                                    </div> 
                                    <div class="card-body">
        ...
        <div class="col-xl-6 col-md-6 col-12">
            <div class="card">
                <div class="card-content collapse show">
                    <div class="text-center">
                        <div class="card-body">
                            <input type="button" class="btn btn-danger" value="TIDAK MEMILIH" onclick="window.location.href='../../library/example/interface/golput.php?pin=<?= $pin; ?>'"/>
                        </div> 
                        <h4 class="card-title">Ini tidak disarankan!</h4>
                    </div>
                </div>
