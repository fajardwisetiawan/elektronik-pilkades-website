...
$provinsi = antiinjection($_POST['provinsi']);
	...
	if (strlen($nik)<16) {
		...
		mysqli_query($connect, "INSERT INTO tb_pemilih (pin, nik, nama, tempat_lahir, tgl_lahir, jk , agama, status_kawin, pekerjaan, alamat, rt, rw, desa, kecamatan, kabupaten, provinsi, foto, keterangan)
		VALUES ('$pin','$nik','$nama','$tempat_lahir','$tgl_lahir','$jk','$agama','$status_kawin', '$pekerjaan','$alamat','$rt', '$rw','$desa','$kecamatan','$kabupaten', '$provinsi','$fotobaru', 'Dapat Hadir ke TPS')");
