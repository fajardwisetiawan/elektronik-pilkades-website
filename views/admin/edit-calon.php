...
<head>
    ...
    <title>Edit Calon - Pemilihan Kepala Desa</title>
										...
										<h4 class="form-section"><i class="ft-user"></i> Personal Info</h4>
											<div class="row">
												<div class="form-group col-12 mb-2">
													...
													<input type="hidden" name="id_calon" value="<?= $qy['id_calon'] ?>" required>
													<input type="text" id="projectinput5" class="form-control" value="<?= $qy['nik'] ?>" placeholder="Masukkan NIK" name="nik" required>
												</div>
											</div>
											<div class="row">
												<div class="form-group col-12 mb-2">
													<label for="projectinput5">Nomor Urut</label>
													<input type="text" id="projectinput5" class="form-control" value="<?= $qy['no_urut'] ?>" placeholder="Masukkan NIK" name="no_urut" required>
												</div>
											</div>
											<div class="row">
												<div class="form-group col-12 mb-2">
											...
											<div class="row">
												<div class="form-group col-12 mb-2">
													...
													<textarea id="projectinput9" rows="5" class="form-control" name="visi" placeholder="Cantumkan Visi" required><?= $qy['visi'] ?></textarea>
												</div>
											</div>
											<div class="row">
												<div class="form-group col-12 mb-2">
													<label for="projectinput9">Misi</label>
													<textarea id="projectinput9" rows="5" class="form-control" name="misi" placeholder="Cantumkan Misi" required><?= $qy['misi'] ?></textarea>
												</div>
											</div>
