...
<head>
	...
	<title>Data Pemilih Belum Memilih - Pemilihan Kepala Desa</title>
							...
							<div class="card-content">
										...
										<div class="col-12">
											<div class="card">
												<div class="card-header">
													<h4 class="card-title">Data Pemilih (Belum Memilih)</h4>
														...
														<div class="table-responsive">
															...
															<table
																...
																<tbody>
																	<?php
								$no = 1;
								$qy = mysqli_query($connect, "SELECT * FROM tb_pemilih WHERE status=0");
								while($q = mysqli_fetch_array($qy)) { ?>
																	<tr>
																		...
																		<?php } ?>
																		<td>
																			<form class="" action="edit-pemilih-belum.php"
																				method="post">
